...
/>
			...
			<div className="Pricing_content">
				<div className="Pricing_headlines">
					<h2 className="Pricing_HeadlineMiniText">Investment Tiers</h2>
					<h2 className="Pricing_HeadlineTitle">Scale Your Intelligence</h2>
					<p className="Pricing_headlinePara">Transparent pricing for transformative AI solutions. Every partnership begins with a discovery call.</p>
			    </div>
				<div id="pricing" className="Pricing_CardsWrapper">
